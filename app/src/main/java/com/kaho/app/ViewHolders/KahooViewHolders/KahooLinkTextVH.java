...
public class KahooLinkTextVH extends RecyclerView.ViewHolder {
    ...
    public KahooLinkTextVH(@NonNull KahooSingleLayoutViewBinding kahooSingleLayoutViewBinding) {
    ...
    public void setUpKahooView(KahooLinkTextVH holder, Fragment mContext,
        ...
        if (urlFromcont.length()>0){
            ...
            LinkPreviewCallback linkPreviewCallback = new LinkPreviewCallback() {
                ...
                public void onPos(SourceContent sourceContent, boolean b) {
                    ...
                    kahooSingleLayoutViewBinding.previewTitle.setText(sourceContent.getTitle());
                        ...
                        try {
                            if (mContext!=null){
                                Glide.with(mContext)
                                        ...
                                        .error(R.color.dark_primary_500)
                                        .override(800, 560)
                                        .into(kahooSingleLayoutViewBinding.linkPreview);
                            }
                        }catch (Exception e){
                            Log.e("kshfkjssds","this is error "+e.getMessage());
                        }
                    }
                    kahooSingleLayoutViewBinding.linkPreviewLayout.setVisibility(View.VISIBLE);
                }
            };
            ...
            if (PublicMethods.isYoutubeUrl(urlFromcont)||urlFromcont.contains(".mp4")||urlFromcont.contains(".3gp")){
                kahooSingleLayoutViewBinding.linkVideoPlay.setVisibility(View.VISIBLE);
            }else {
                kahooSingleLayoutViewBinding.linkVideoPlay.setVisibility(View.GONE);
            }
            kahooSingleLayoutViewBinding.linkPreviewLayout.setOnClickListener(new View.OnClickListener() {
                @Override
                ...
                new HashTagHelper.OnHashTagClickListener() {
                    ...
                    public void onHashTagClicked(String tagType,String hashTag) {
                        try {
                            ...
                            Log.e("kjhfksfsfre","this is error "+e.getMessage());
                        }
