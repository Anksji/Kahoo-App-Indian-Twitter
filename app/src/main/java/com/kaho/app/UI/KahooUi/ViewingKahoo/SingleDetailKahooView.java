...
import com.kaho.app.databinding.FragmentSingleDetailKahooBinding;
...
public class SingleDetailKahooView extends Fragment {

    FragmentSingleDetailKahooBinding singleDetailKahooBinding;
    ...
    KahooPostModel kahooPostModel;
    String kahooPostId;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        singleDetailKahooBinding=FragmentSingleDetailKahooBinding.inflate(inflater,container,false);
        return singleDetailKahooBinding.getRoot();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        kahooListAdapter = new KahooListAdapter(SingleDetailKahooView.this,false,kahooList);
        linearLayoutManager=new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
        singleDetailKahooBinding.kahooListRv.setLayoutManager(linearLayoutManager);
        singleDetailKahooBinding.kahooListRv.setAdapter(kahooListAdapter);

        clickListener();

        singleDetailKahooBinding.skimmerView.shimmerViewContainer.startShimmer();

        Bundle bundle=getArguments();
        kahooPostModel=(KahooPostModel) bundle.getSerializable("kahoo_post");
        kahooPostId = kahooPostModel.getKahooPostId();

        kahooList.add(0,kahooPostModel);
        if (kahooList.size()>0){
            singleDetailKahooBinding.skimmerView.shimmerViewContainer.setVisibility(View.GONE);
            singleDetailKahooBinding.skimmerView.shimmerViewContainer.stopShimmer();
        }else {
            singleDetailKahooBinding.skimmerView.shimmerViewContainer.startShimmer();
            singleDetailKahooBinding.skimmerView.shimmerViewContainer.setVisibility(View.VISIBLE);
        }

        singleDetailKahooBinding.swipeToRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
    ...
    private void clickListener() {
        singleDetailKahooBinding.ivBack.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onDestroyView() {
        super.onDestroyView();
        if (singleDetailKahooBinding.kahooListRv!=null){
            singleDetailKahooBinding.kahooListRv.releasePlayer();
        }
    }
    ...
    public void onPause() {
        super.onPause();
        if (singleDetailKahooBinding.kahooListRv!=null){
            singleDetailKahooBinding.kahooListRv.pauseVideo();
        }
    }
    ...
    public void onResume() {
        super.onResume();
        if (singleDetailKahooBinding.kahooListRv!=null){
            singleDetailKahooBinding.kahooListRv.resumeVideo();
        }
    }
    ...
    public void openMediaFile(int position,KahooPostModel kahooPostModel){
        ...
        if (kahooPostModel.getKaho_media_list().size()>0){
            singleDetailKahooBinding.mediaView.setVisibility(View.VISIBLE);
            singleDetailKahooBinding.playerView.setVisibility(View.VISIBLE);
        ...
        singleDetailKahooBinding.leftMove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                singleDetailKahooBinding.mediaImage.setVisibility(View.GONE);
                singleDetailKahooBinding.idExoPlayerVIew.setVisibility(View.GONE);
                openMedia(false);
            }
        });
        singleDetailKahooBinding.rightMove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                singleDetailKahooBinding.mediaImage.setVisibility(View.GONE);
                singleDetailKahooBinding.idExoPlayerVIew.setVisibility(View.GONE);
        ...
        singleDetailKahooBinding.closeMediaView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                closeMedia();
            }
        });
        singleDetailKahooBinding.playerView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                closeMedia();
            }
    ...
    private void openMediaAnimation() {
        ...
        singleDetailKahooBinding.centerView.startAnimation(animation);

        Animation animation2 = AnimationUtils.loadAnimation(getContext(), R.anim.fade_in_anim);
        animation.setStartOffset(0);
        singleDetailKahooBinding.closeMediaView.startAnimation(animation2);
    }
    ...
    private void closeMedia() {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                singleDetailKahooBinding.playerView.setVisibility(View.GONE);
            }
        },490);
    ...
    private void openMedia(boolean isRight) {
        ...
        singleDetailKahooBinding.mediaIndex.setText(""+(1+currentMediaIndex)+"/"+(imageMediaList.size()));
        ...
        if (imageMediaList.size()>currentMediaIndex&&currentMediaIndex>=0){
            ...
            if (isVideo(imageMediaList.get(currentMediaIndex))) {
                ...
                singleDetailKahooBinding.mediaImage.setVisibility(View.GONE);
                singleDetailKahooBinding.idExoPlayerVIew.setVisibility(View.VISIBLE);
            } else {
    ...
    public void kahoMediaClicked(int index,KahooPostModel kahooPostModel){
        ...
        if (kahooPostModel.getKaho_media_list().size()>0&&isVideo(kahooPostModel.getKaho_media_list().get(0))){
            singleDetailKahooBinding.kahooListRv.playVideoFromIndex(index,kahooPostModel.getKaho_media_list().get(0));
        }
    ...
    private void initializePlayer() {
        ...
        singleDetailKahooBinding.idExoPlayerVIew.setPlayer(player);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viewModelKahoo=new ViewModelProvider(SingleDetailKahooView.this).get(KahooViewModel.class);
    ...
    private void getKahooList() {
        KahooListLiveData productListLiveData = viewModelKahoo.getSingleKahooThreadListLiveData(kahooPostId,isReload);
        isReload=false;
        if (productListLiveData != null) {
            productListLiveData.observe(getViewLifecycleOwner(), operation -> {
                ...
                if (singleDetailKahooBinding.swipeToRefresh.isRefreshing()){
                    singleDetailKahooBinding.swipeToRefresh.setRefreshing(false);
                }

                Log.e("dskjfhkjdfsf","skimmer is gone");
                if (singleDetailKahooBinding.skimmerView.shimmerViewContainer.isShimmerVisible()){
                    singleDetailKahooBinding.skimmerView.shimmerViewContainer.stopShimmer();
                    singleDetailKahooBinding.skimmerView.shimmerViewContainer.setVisibility(View.GONE);
                }
            });
    ...
    private void initRecyclerViewOnScrollListener() {
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    ...
                    if (!recyclerView.canScrollVertically(1)) {
                        singleDetailKahooBinding.kahooListRv.playVideo(true,kahooListAdapter.getItemList().size()-1,kahooListAdapter);
                    } else {
                        singleDetailKahooBinding.kahooListRv.playVideo(false,0,kahooListAdapter);
                    }
                }
            }
        ...
        singleDetailKahooBinding.kahooListRv.addOnScrollListener(onScrollListener);
    }
    ...
    public void dobaraKahooClicked(KahooPostModel dataKahoPost, int position) {
        ...
        navController.navigate(R.id.action_singleDetailKahoo_to_dobaraKahooAurReplyFrag,bundle);
    }
    ...
    public void editKahoo(KahooPostModel kahooPostModel, int position) {
        ...
        navController.navigate(R.id.action_singleDetailKahoo_to_editKahooFragment,bundle);
    }
    ...
    public void showDetailKahoo(KahooPostModel dataKahoPost) {
        Bundle bundle =new Bundle();
        bundle.putSerializable("kahoo_post",dataKahoPost);
        navController.navigate(R.id.action_singleDetailKahoo_self,bundle);
    }
    ...
    public void showUserDetail(KahooPostModel dataKahoPost) {
        ...
        navController.navigate(R.id.action_singleDetailKahoo_to_viewProfileFragment,bundle);
    }
    ...
    public void showTagKahooDetail(String tag,boolean isHashTag) {
        if (isHashTag){
            ...
            navController.navigate(R.id.action_singleDetailKahoo_to_singleHashTagKahooView,bundle);
        }else {
