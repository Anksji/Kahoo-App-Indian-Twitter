...
import com.kaho.app.databinding.FragmentMyKahooListBinding;
...
public class MyKahooListFrag extends Fragment {

    private NavController navController;
    FragmentMyKahooListBinding myKahooListBinding;
    ...
    public MyKahooListFrag(String userId, boolean isOtherProfile) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myKahooListBinding=FragmentMyKahooListBinding.inflate(inflater,container,false);
        return myKahooListBinding.getRoot();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        kahooListAdapter = new KahooListAdapter(MyKahooListFrag.this,false,kahooList);
        linearLayoutManager=new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
        myKahooListBinding.kahooListRv.setLayoutManager(linearLayoutManager);
        myKahooListBinding.kahooListRv.setAdapter(kahooListAdapter);
        ...
        if (kahooList.size()>0){
            myKahooListBinding.mySkimmerView.shimmerViewContainer.setVisibility(View.GONE);
            myKahooListBinding.mySkimmerView.shimmerViewContainer.stopShimmer();
        }else {
            myKahooListBinding.mySkimmerView.shimmerViewContainer.startShimmer();
            myKahooListBinding.mySkimmerView.shimmerViewContainer.setVisibility(View.VISIBLE);
        }
        
        myKahooListBinding.swipeToRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
    ...
    public void refreshList(){
        myKahooListBinding.emptyAnimation.setVisibility(View.GONE);
        isReload=true;
        kahooList.clear();
    ...
    public void onDestroyView() {
        super.onDestroyView();
        if (myKahooListBinding.kahooListRv!=null){
            myKahooListBinding.kahooListRv.releasePlayer();
        }
    }
    ...
    public void onPause() {
        super.onPause();
        if (myKahooListBinding.kahooListRv!=null){
            myKahooListBinding.kahooListRv.pauseVideo();
        }
    }
    ...
    public void onResume() {
        super.onResume();
        if (myKahooListBinding.kahooListRv!=null){
            myKahooListBinding.kahooListRv.resumeVideo();
        }
    }
    ...
    public void openMediaFile(int position,KahooPostModel kahooPostModel){
        ...
        if (kahooPostModel.getKaho_media_list().size()>0){
            myKahooListBinding.mediaView.setVisibility(View.VISIBLE);
            myKahooListBinding.playerView.setVisibility(View.VISIBLE);
        ...
        myKahooListBinding.leftMove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myKahooListBinding.mediaImage.setVisibility(View.GONE);
                myKahooListBinding.idExoPlayerVIew.setVisibility(View.GONE);
                openMedia(false);
            }
        });
        myKahooListBinding.rightMove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myKahooListBinding.mediaImage.setVisibility(View.GONE);
                myKahooListBinding.idExoPlayerVIew.setVisibility(View.GONE);
        ...
        myKahooListBinding.closeMediaView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                closeMedia();
            }
        });
        myKahooListBinding.playerView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                closeMedia();
            }
    ...
    private void openMediaAnimation() {
        ...
        myKahooListBinding.centerView.startAnimation(animation);

        Animation animation2 = AnimationUtils.loadAnimation(getContext(), R.anim.fade_in_anim);
        animation.setStartOffset(0);
        myKahooListBinding.closeMediaView.startAnimation(animation2);
    }
    ...
    private void closeMedia() {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                myKahooListBinding.playerView.setVisibility(View.GONE);
            }
        },490);
    ...
    private void openMedia(boolean isRight) {
        ...
        myKahooListBinding.mediaIndex.setText(""+(1+currentMediaIndex)+"/"+(imageMediaList.size()));
        ...
        if (imageMediaList.size()>currentMediaIndex&&currentMediaIndex>=0){
            ...
            if (isVideo(imageMediaList.get(currentMediaIndex))) {
                ...
                myKahooListBinding.mediaImage.setVisibility(View.GONE);
                myKahooListBinding.idExoPlayerVIew.setVisibility(View.VISIBLE);
            } else {
    ...
    public void kahoMediaClicked(int index,KahooPostModel kahooPostModel){
        ...
        if (kahooPostModel.getKaho_media_list().size()>0&&isVideo(kahooPostModel.getKaho_media_list().get(0))){
            myKahooListBinding.kahooListRv.playVideoFromIndex(index,kahooPostModel.getKaho_media_list().get(0));
        }
    ...
    private void initializePlayer() {
        ...
        myKahooListBinding.idExoPlayerVIew.setPlayer(player);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viewModelKahoo=new ViewModelProvider(MyKahooListFrag.this).get(KahooViewModel.class);
    ...
    private void updateOnNoData() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if (kahooList.size()==0){
                    myKahooListBinding.emptyAnimation.setVisibility(View.VISIBLE);
                    if (myKahooListBinding.mySkimmerView.shimmerViewContainer.isShimmerVisible()){
                        myKahooListBinding.mySkimmerView.shimmerViewContainer.stopShimmer();
                        myKahooListBinding.mySkimmerView.shimmerViewContainer.setVisibility(View.GONE);
                    }
                    if (myKahooListBinding.swipeToRefresh.isRefreshing()){
                        myKahooListBinding.swipeToRefresh.setRefreshing(false);
                    }
                }
            }
    ...
    private void getKahooList() {
        updateOnNoData();
        KahooListLiveData productListLiveData = viewModelKahoo.getUsrKahooFeedListLiveData(currentUserId,isReload);
        isReload=false;
    ...
    private void initRecyclerViewOnScrollListener() {
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    ...
                    if (!recyclerView.canScrollVertically(1)) {
                        myKahooListBinding.kahooListRv.playVideo(true,kahooListAdapter.getItemList().size()-1,kahooListAdapter);
                    } else {
                        myKahooListBinding.kahooListRv.playVideo(false,0,kahooListAdapter);
                    }
                }
            }
        ...
        myKahooListBinding.kahooListRv.addOnScrollListener(onScrollListener);
    }
