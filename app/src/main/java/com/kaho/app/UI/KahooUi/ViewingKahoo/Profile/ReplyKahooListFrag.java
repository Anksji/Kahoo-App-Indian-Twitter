...
public class ReplyKahooListFrag extends Fragment {

    FragmentReplyKahooListBinding dobaraKahooAurReplyBinding;
    ...
    public ReplyKahooListFrag(String userId, boolean isOtherProfile) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dobaraKahooAurReplyBinding=FragmentReplyKahooListBinding.inflate(inflater,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        kahooListAdapter = new KahooListAdapter(ReplyKahooListFrag.this,false,kahooList);
        ...
        if (kahooList.size()>0){
            dobaraKahooAurReplyBinding.shimmerViewContainerReply.setVisibility(View.GONE);
            dobaraKahooAurReplyBinding.shimmerViewContainerReply.stopShimmer();
        }else {
            dobaraKahooAurReplyBinding.shimmerViewContainerReply.startShimmer();
            dobaraKahooAurReplyBinding.shimmerViewContainerReply.setVisibility(View.VISIBLE);
        }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viewModelKahoo=new ViewModelProvider(ReplyKahooListFrag.this).get(KahooViewModel.class);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if (kahooList.size()==0){
                    ...
                    if (dobaraKahooAurReplyBinding.shimmerViewContainerReply.isShimmerVisible()){
                        dobaraKahooAurReplyBinding.shimmerViewContainerReply.stopShimmer();
                        dobaraKahooAurReplyBinding.shimmerViewContainerReply.setVisibility(View.GONE);
                    }
    ...
    private void getKahooList() {
        updateOnNoData();
        KahooListLiveData productListLiveData = viewModelKahoo.getReplyKahooFeedListLiveData(currentUserId,isReload);
        isReload=false;
